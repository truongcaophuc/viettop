...
export default function OutstandingSolutions() {
  return (
    <section className="py-20 bg-gray-50 px-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 md:order-1">
            <img
              src={hvacImage.src}
              alt="HVAC System"
              className="w-full rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-500"
            />
          </div>
          ...
          <div className="order-1 md:order-2 space-y-6">
            ...
            <p className="text-gray-600 text-base leading-relaxed">
              ...
              năng lượng lên đến{" "}
              <span className="font-semibold text-blue-600">40%</span> so với hệ
            ...
            <button className="mt-4 px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors duration-300">
              Tìm hiểu chi tiết
            </button>
          </div>
        </div>
